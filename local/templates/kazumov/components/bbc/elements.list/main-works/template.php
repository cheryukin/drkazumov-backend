...
<section class="section">
    <div class="wrapper">
        <div class="title-box">
            <h2 class="title"><?= Loc::getMessage("WORKS_BLOCK_TITLE") ?></h2>
            <a href="/works/" class="button button_border">
                <?= Loc::getMessage("WORKS_BLOCK_MORE") ?>
            </a>
        </div>
        <div class="works js-slider-works">
            <div class="y-row">
            ...
            <div class="works-nav-wrapper  hidden">
                <div class="works-nav"></div>
            </div>
        </div>
        <div class="more">
            <a href="/works/" class="button button_lg button_border">
                <?= Loc::getMessage("WORKS_BLOCK_MORE") ?>
            </a>
        </div>
    </div>
