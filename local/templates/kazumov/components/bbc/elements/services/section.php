...
if ($isDetail) {
    $APPLICATION->IncludeComponent('bbc:elements.detail', 'service-detail', array(
...
$activeTags = $APPLICATION->IncludeComponent(
    ...
    [
        'IBLOCK_ID' => $arParams['IBLOCK_ID'],
        'SECTION_CODE' => $arResult['VARIABLES']['SECTION_ID'],
...
?>
<? $APPLICATION->IncludeComponent('bbc:elements.list', 'services-list', array(
    'IBLOCK_TYPE' => $arParams['IBLOCK_TYPE'],
    'IBLOCK_ID' => $arParams['IBLOCK_ID'],
